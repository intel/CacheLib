...
public:
  ...
  std::vector<size_t> calculateBatchSizes(const CacheBase& cache, std::vector<MemoryDescriptorType> acVecs); //function to calculate number of items to evict for alloc. classes in the batch
